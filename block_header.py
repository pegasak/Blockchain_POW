...
# --- Шаг 1: Составляем заголовок ---
block_size = b"\x01\x00\x02\x00"  # любые 4 ненулевых байта
...
# метка времени: [часы, день, месяц, год]
t = time.localtime()
timestamp = bytes([t.tm_hour, t.tm_mday, t.tm_mon, t.tm_year - 2000])  # 4 байта
...
for nonce in range(max_nonce):
    ...
    if int.from_bytes(h, 'big') >> 251 == 0:  # первые 5 бит = 0
